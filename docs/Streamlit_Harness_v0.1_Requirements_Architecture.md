# Streamlit Harness v0.1 – Requirements & Architecture
Version: v0.1
Date: 2025-12-22

## 1) Purpose

Build a **debug-first Streamlit harness** for the SPAR Engine v0.1. This harness is not a “product UI,” it is a **development and tuning instrument** that makes it easy to validate:
...
- Content pack path (default: `data/core_complications_v0_1.json`)
- Seed (int)
